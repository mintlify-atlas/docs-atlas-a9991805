...
description: "Deploy devops/scheduler/template.yml to provision EventBridge Scheduler rules and Lambda functions that start and stop the EC2 instance on weekdays."
---
