...
sidebarTitle: "CI/CD"
description: "GitHub Actions workflows for GSM Infrastructure automatically deploy CloudFormation stacks on push to develop, quality, and main — with OIDC keyless AWS authentication."
---
...
The full trigger block used in both workflows:
