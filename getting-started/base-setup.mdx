---
title: "Deploy the Base Stack: OIDC Provider and IAM Role"
sidebarTitle: "Base Setup"
description: "Deploy the GSM Infrastructure base CloudFormation stack to create the GitHub OIDC provider and least-privilege IAM executor role for keyless CI/CD authentication."
---
