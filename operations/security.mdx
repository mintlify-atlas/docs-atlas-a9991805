---
title: "GSM Infrastructure Security: IAM, OIDC, and Network Controls"
...
<CardGroup cols={1}>
  <Card title="ParametersResourcesPolicy" icon="sliders">
    ...
    - **SSM Session Manager** — `StartSession`, `TerminateSession`, `ResumeSession`, `DescribeSessions`, `GetConnectionStatus` on any resource (required for Console access)
